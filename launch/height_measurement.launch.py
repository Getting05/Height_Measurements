...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument("publish_topic", default_value="/height_measurements"),
        DeclareLaunchArgument("publish_rate", default_value="50.0"),
        DeclareLaunchArgument("height_formula", default_value="terrain_minus_base"),
        DeclareLaunchArgument("measured_height_offset", default_value="0.5"),
